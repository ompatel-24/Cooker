              ...
              <div className="flex flex-col gap-2">
                ...
                {appUser && (
                  <div className="text-sm text-gray-500 dark:text-gray-400">
                    Synced to Supabase user id: <span className="font-mono">{appUser.id}</span>
                  </div>
                )}
                ...
                <div>
                  <a
                    href="/auth/logout"
                    className="inline-flex px-4 py-2 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-500 transition"
                  >
                    Log out
                  </a>
                </div>
